...
\begin{tabular}{l|c|c}
    ...
    $\diamond\square(\lnot Teig \lor Hitze)$                     & $\bot$ & $\top$ \\
    $\square\diamond(\lnot Teig \lor Hitze)$                     & $\top$ & $\top$ \\
    $\square(Hitze ~\textbf{U}~ Backen)$                         & $\bot$ & $\bot$ \\
    $\square\diamond(Backen \Rightarrow \circ\circ\lnot Backen)$ & $\bot$ & $\top$ \\
    $\square((Hitze \land Teig) \Rightarrow \diamond\lnot Teig)$ & $\top$ & $\top$ \\
    $\circ\circ\diamond(\lnot Hitze \land \lnot Teig)$           & $\bot$ & $\bot$ \\
\end{tabular}
