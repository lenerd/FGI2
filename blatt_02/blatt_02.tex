...
\begin{enumerate}
		...
		\item[zu 3.:] \textbf{Lösung:}\\
            ...
            \begin{proof} \hfill \\
                    ...
                    Sei $w \in (L(A_{2.3}))^\omega $. Dann gilt $w = a_1a_2a_3....$ mit $a_i \in L(A\{2_3\}) $ für alle $i$. \\
                    Nach dem Lesen des Teilwertes $a_i$ findet sich $A\{2_3\}$ in einem Endzustand. Nach Konstruktion befindet sich $A'$ nichtdeterministisch in $F'=Q_0$. Anschließend kann das nächste $a_i$ gelesen werden. da $w$ unendlich lang ist, befindet sich $A'$ unendlich oft in $F'$ und akzeptiert $w$. Daraus folgt $w \in L^\omega(A')$. 
